...
#ifndef __INET_HOSTAUTOCONFIGURATORWIFI_H
#define __INET_HOSTAUTOCONFIGURATORWIFI_H
 ...
 */
class INET_API HostAutoConfiguratorWifi : public OperationalBase
{
  protected:
...
#endif // ifndef __INET_HOSTAUTOCONFIGURATORWIFI_H
