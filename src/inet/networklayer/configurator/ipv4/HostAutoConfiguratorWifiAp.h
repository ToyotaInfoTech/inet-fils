...
#ifndef __INET_HOSTAUTOCONFIGURATORWIFIAP_H
#define __INET_HOSTAUTOCONFIGURATORWIFIAP_H
 ...
 */
class INET_API HostAutoConfiguratorWifiAp : public OperationalBase
{
  protected:
...
#endif // ifndef __INET_HOSTAUTOCONFIGURATORWIFIAP_H
