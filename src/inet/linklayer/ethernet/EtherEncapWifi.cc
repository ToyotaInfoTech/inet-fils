...
#include "inet/linklayer/ethernet/EtherEncapWifi.h"
...
Define_Module(EtherEncapWifi);

simsignal_t EtherEncapWifi::encapPkSignal = registerSignal("encapPk");
simsignal_t EtherEncapWifi::decapPkSignal = registerSignal("decapPk");
simsignal_t EtherEncapWifi::pauseSentSignal = registerSignal("pauseSent");

EtherEncapWifi::~EtherEncapWifi()
{
    for (auto it : socketIdToSocketMap)
        delete it.second;
}

bool EtherEncapWifi::Socket::matches(Packet *packet, const Ptr<const EthernetMacHeader>& ethernetMacHeader)
{
...
void EtherEncapWifi::initialize(int stage)
{
...
void EtherEncapWifi::processCommandFromHigherLayer(Request *msg)
{
...
void EtherEncapWifi::refreshDisplay() const
{
...
void EtherEncapWifi::processPacketFromHigherLayer(Packet *packet)
{
...
const Ptr<const EthernetMacHeader> EtherEncapWifi::decapsulateMacHeader(Packet *packet)
{
...
void EtherEncapWifi::processPacketFromMac(Packet *packet)
{
...
void EtherEncapWifi::handleSendPause(cMessage *msg)
{
