...
#include "inet/linklayer/ieee80211/portal/Ieee80211PortalWifi.h"
...
Define_Module(Ieee80211PortalWifi);

void Ieee80211PortalWifi::initialize(int stage)
{
...
void Ieee80211PortalWifi::handleMessage(cMessage *message)
{
...
void Ieee80211PortalWifi::encapsulate(Packet *packet)
{
    ...
    auto ethernetHeader = EtherEncapWifi::decapsulateMacHeader(packet);       // do not use const auto& : trimChunks() delete it from packet
    packet->trim();
...
void Ieee80211PortalWifi::decapsulate(Packet *packet)
{
...
void Ieee80211PortalWifi::filsDecapsulate(Packet *packet)
{
